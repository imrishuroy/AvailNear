...
// class PlaceExp extends StatefulWidget {
//   const PlaceExp({Key? key}) : super(key: key);

//   static const String routeName = '/PlaceExp';
...
//         )..getCurrentLocation(),
//         child: const PlaceExp(),
//       ),
//     );
//   }

//   @override
//   _PlaceExpState createState() => _PlaceExpState();
// }

// class _PlaceExpState extends State<PlaceExp> {
...
//                               placeId: predictions[index].placeId ?? '1',
//                               googlePlace: googlePlace!,
//                             ),
//                           ),
//                         );
...
//       _DetailsPageState(placeId: this.placeId, googlePlace: this.googlePlace);
// }
...
//   _DetailsPageState({required this.placeId, required this.googlePlace});
