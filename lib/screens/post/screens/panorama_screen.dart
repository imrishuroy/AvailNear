...
class PanormaScreen extends StatefulWidget {
  static const String routeName = '/panorma';
  final String? title;

  static Route route() {
    return MaterialPageRoute(
      builder: (_) => const PanormaScreen(),
    );
  }

  const PanormaScreen({Key? key, this.title}) : super(key: key);

  @override
  _PanormaScreenState createState() => _PanormaScreenState();
}

class _PanormaScreenState extends State<PanormaScreen> {
  // double _lon = 0;
  // double _lat = 0;
  // double _tilt = 0;
  ///int _panoId = 0;
  List<Image> panoImages = [
    ...
    Image.asset('assets/images/panorama_cropped.jpeg'),
  ];
